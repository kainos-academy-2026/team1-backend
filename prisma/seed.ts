	...
	await prisma.jobRole.createMany({
		data: [
			...
			},
			{
				...
				status: 'open',
				specification: 'https://kainossoftwareltd.sharepoint.com/sites/Career/JobProfiles/Data%20and%20Artificial%20Intelligence/Job%20Profile%20-%20Senior%20Data%20Scientist%20(Senior%20Associate).pdf',
				description: 'Analyze and interpret complex data to drive business decisions.',
				responsibilities: 'Collect, process, and analyze data to provide insights.',
			...
			},
			{
				...
				status: 'closed',
				specification: 'https://kainossoftwareltd.sharepoint.com/sites/Career/JobProfiles/Product/Job%20Profile%20-%20Product%20Consultant%20(Manager).pdf',
